...
import bachImg from "../../multimedia/zavrsni_img.jpg"
import masterImg from "../../multimedia/diplomski_img.jpg"
const College = () => {
    return (
        <>
            ...
            <Row>
                <Col className="text" xxl={7}>
                    ...
                    <p className="story">
                        During the first two years of my undergraduate program, 
                        ...
                        Eventually, this led me to delve into the field of machine learning.

                        <br></br> &emsp; Under the guidance of my mentor, Marko Subašić, I conducted my bachelor's thesis, titled
                        ...
                        was evaluated using a dataset collected specifically for this project.

                        <br></br> &emsp;My master's thesis, similarly conducted under the guidance of Marko, was titled 
